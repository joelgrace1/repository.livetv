...
class Main:
    ...
    def __init__(self):
        ...
        common.log('Desporto Rei initialized')
    ...
    def run(self, argv=None):
        ...
        self.addon = Addon('plugin.video.desportorei', argv)

        common.log('Desporto Rei running')
        ...
        try:
            ...
            common.showError('Error running Desporto Rei')
            common.log('Error running Desporto Rei. Reason:' + str(e))
