...
base='www.ManiaC.com'
ADDON=xbmcaddon.Addon(id='plugin.video.ManiaC V5 Final')
...
def CATEGORIES():
    link = OPEN_URL('https://copy.com/w4LPlZc04pVVuab1').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("ManiaC Wizard","Downloading ",'', 'Please Wait')
